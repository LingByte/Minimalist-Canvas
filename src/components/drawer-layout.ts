...
const iconBadgeToneClassName: Record<IconBadgeTone, string> = {
  ...
  return createElement(
    ...
    props.icon
      ? createElement(
          ...
          {
            className: cn(
              'flex size-8 shrink-0 items-center justify-center rounded-lg [&>svg]:size-4 [&>svg]:shrink-0',
              iconBadgeToneClassName[props.iconTone ?? 'neutral']
            ),
            'aria-hidden': true,
          },
          props.icon
