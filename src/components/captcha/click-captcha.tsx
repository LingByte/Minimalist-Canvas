...
export function ClickCaptcha({ session, onChange }: Props) {
  ...
  return (
    <div className='space-y-2'>
      <p className='text-sm text-neutral-600 dark:text-neutral-300'>
        {t('Please click in order: {{sequence}}', { sequence: targetHint })}
      </p>
      <div
        ref={boardRef}
        role='button'
        ...
        className='captcha-click-board relative overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700'
        style={{
          width: '100%',
          maxWidth: width,
      ...
      <p className='text-xs text-neutral-500'>
        {done
          ? t('Clicks complete, ready to submit')
          : t('Clicked {{current}}/{{total}}', {
