...
export function DataTableToolbar<TData>(props: DataTableToolbarProps<TData>) {
  ...
  if (hasSearch) {
    ...
    resetButton = (
      <Button
        type='text'
        onClick={handleReset}
        className='text-muted-foreground hover:text-foreground inline-flex items-center gap-1 px-2'
      >
        {t('Reset')}
  ...
  const expandToggle = hasExpandable ? (
    <Button
      ...
      className={cn(
        'text-muted-foreground hover:text-foreground inline-flex items-center gap-1 px-2',
