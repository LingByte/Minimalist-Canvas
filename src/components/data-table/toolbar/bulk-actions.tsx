  ...
  return (
    <>
      ...
      >
        ...
        >
          <Tooltip title={t('Clear selection (Escape)')}>
            <Button
              type='default'
              size='small'
          ...
          >
            <Badge
              count={selectedCount}
              className='[&_.ant-badge-count]:min-w-8 [&_.ant-badge-count]:rounded-lg'
