...
export function useFilters(models: PricingModel[]) {
  ...
  const [filterState, setFilterState] = useState<FilterState>(() => ({
    ...
    tokenUnit: searchParams.get('tokenUnit') === 'K' ? 'K' : undefined,
    view: searchParams.get('view') === 'table' ? 'table' : undefined,
    rechargePrice: searchParams.get('rechargePrice') === 'true' || undefined,
  }))
