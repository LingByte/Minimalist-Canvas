...
import { Button, Drawer, Skeleton, Tabs, Typography } from 'antd'
import { PricingAntProvider } from './pricing-ant-provider'
          ...
          if (value === 'overview') {
            children = (
              <div className='space-y-6'>
                ...
                <section
                  className='space-y-5 rounded-xl border p-4 shadow-sm'
                  style={{
            ...
            children = <ModelDetailsPerformance model={props.model} />
          } else {
            children = (
              <ModelDetailsApi
                model={props.model}
...
export function ModelDetailsDrawer(props: ModelDetailsDrawerProps) {
  ...
  return (
    <Drawer
      ...
      destroyOnHidden
    >
      <Typography.Paragraph type='secondary' className='sr-only'>
        {t('Model details')}
...
export function ModelDetails() {
  ...
  const handleBack = () => {
    navigate(`/pricing?${searchParams.toString()}`)
  }
      ...
      <PublicLayout showMainContainer={false}>
        <PricingAntProvider>
          <div className='mx-auto max-w-2xl px-4 py-16 text-center sm:px-6'>
            <Typography.Title level={4}>{t('Model not found')}</Typography.Title>
            <Typography.Paragraph type='secondary'>
              {t("The model you're looking for doesn't exist.")}
            </Typography.Paragraph>
            <Button onClick={handleBack}>{t('Back to Models')}</Button>
          </div>
        </PricingAntProvider>
      </PublicLayout>
    )
      ...
      <PricingAntProvider>
        <div className='mx-auto max-w-5xl px-4 py-8 sm:px-6'>
          ...
          <ModelDetailsContent
            ...
            tokenUnit={tokenUnit}
            showRechargePrice={searchParams.get('rechargePrice') === 'true'}
            endpointMap={
