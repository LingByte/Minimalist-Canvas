...
export const AnimatedThemeToggler = ({ children, className, duration = 400, variant, fromCenter = false, theme, targetTheme, onThemeChange, ...props }: AnimatedThemeTogglerProps) => {
    ...
    const toggleTheme = useCallback(() => {
        ...
        const applyTheme = () => {
            ...
            // Prefer the parent handler (host ThemeProvider / canvas store).
            // When uncontrolled, update documentElement with both light/dark
            // classes so Tailwind and host headers stay consistent.
            if (onThemeChange) {
