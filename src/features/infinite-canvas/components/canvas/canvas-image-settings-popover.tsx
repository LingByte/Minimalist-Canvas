...
import { ImageSettingsPanel, contractImageSummaryLabel, imageQualityLabel, imageSizeLabel } from "@canvas/components/image-settings-panel";
...
export function CanvasImageSettingsPopover({ config, onConfigChange, onOpenChange, buttonClassName, placement = "topLeft" }: CanvasImageSettingsPopoverProps) {
    ...
    const summary = isContractImageModel(modelName)
        ? contractImageSummaryLabel({ ...config, model: modelName })
