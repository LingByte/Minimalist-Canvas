export default {
    ...
    common: {
        ...
        uploadTooLarge: "文件大小约 {{sizeMb}}MB，超过上传上限 {{limitMb}}MB，请压缩后再试",
        uploadImageTooLarge: "这张图片约 {{sizeMb}}MB，超过图片 {{limitMb}}MB 上限。请点画布右下角圆形工具按钮，用「图片压缩」后再上传",
        uploadAudioTooLarge: "这个音频约 {{sizeMb}}MB，超过音频 {{limitMb}}MB 上限，请压缩后再试",
    },
    settingsPanels: {
        ...
        video: { title: "视频设置", quality: "清晰度", size: "尺寸", seconds: "秒数", resolution: "分辨率", ratio: "比例", duration: "时长", smart: "智能", output: "输出", generateAudio: "生成声音", watermark: "添加水印", adaptive: "自适应", count: "生成数量", videos: "{{count}} 个", sizes: { landscape: "横屏", portrait: "竖屏", square: "方形", widescreen: "宽屏", tall: "长图", auto: "自动" }, ratios: { landscape: "横屏", portrait: "竖屏", square: "方形", standardLandscape: "标准横屏", standardPortrait: "标准竖屏", cinematic: "宽银幕", adaptive: "自适应" } },
        ...
        model: { select: "选择模型", search: "搜索模型", noSearchResult: "没有匹配的模型", assign: "请先在渠道里为{{capability}}指定模型", noMatch: "暂无匹配的{{capability}}模型", addFirst: "请先到配置里添加渠道和模型", capabilities: { image: "生图", video: "视频", text: "文本", audio: "音频" } },
    },
    ...
    assets: {
        title: "我的资产",
        description: "优先读写本机缓存；登录后会与云端同步。清理本地副本后仍可从服务器恢复已同步项。",
    ...
    workbench: {
        ...
        retrySuccess: "重试成功",
        retentionTip: "素材图片/视频仅保存 2 天哦，有需要的可以也备份下载一份到本地。",
        imageMode: "图片生成",
        videoMode: "视频生成",
        styleLibrary: "风格词库",
        modelHint: "选择模型，自由多参考图，效果全面升级",
        modes: "工作台模式",
        confirmSpendTitle: "确认生成？",
        confirmSpend: "本次预计花费 {{price}}，是否继续？",
        confirmSpendCount: "将生成 {{count}} 次，单价约 {{price}}，是否继续？",
        confirmSpendOk: "确认生成",
        pricePerRequest: "{{price}} / 次",
        ...
        cancelUpload: "取消上传",
        referenceSizeHint: "单张参考图不超过 {{imageMb}}MB",
        mediaReferenceSizeHint: "大小限制：图片 {{imageMb}}MB · 视频 {{videoMb}}MB · 音频 {{audioMb}}MB",
    },
    imageWorkbench: {
        title: "生图工作台",
        promptPlaceholder: "可以直接描述想生成的图片内容，也可查看提示词库提升生成效果",
        references: "参考生图 (可选)",
        removeReference: "移除参考图",
        dropReferences: "松开即可添加参考图",
        noReferences: "暂无参考图，可将图片拖到这里",
        referencesFull: "参考图已满（最多 10 张）",
    ...
    videoWorkbench: {
        title: "视频创作台",
        promptPlaceholder: "描述镜头运动、主体动作、场景氛围和画面风格。上传参考图后可输入 @ 插入「图片1」等引用",
        references: "参考图 (可选)",
        videoReferences: "参考视频 (可选)",
        audioReferences: "参考音频 (可选)",
        removeImage: "移除参考图",
        removeVideo: "移除参考视频",
        removeAudio: "移除参考音频",
        ...
        busy: "视频工作台已有任务正在运行",
        generated: "视频已生成",
        batchHint: "将按顺序生成 {{count}} 个视频，请耐心等待。如非必须，请勿用同一提示词多次生成，以免重复扣费。",
        batchConfirmTitle: "确认批量生成？",
        batchConfirmOk: "继续生成",
        batchPartial: "批量完成：成功 {{success}}，失败 {{fail}}",
        batchDone: "已生成 {{count}} 个视频",
        timeout: "视频生成超时，请稍后重试",
        resultTitle: "生成视频 {{count}}",
        source: "视频创作台",
        empty: "还没有生成视频",
    },
    canvas: {
        defaultTitle: "至简画布 {{count}}",
        library: "画布库",
        libraryDescription: "在这里打开、新建或导入画布。每个画布独立保存节点、连线与外观。",
        title: "至简画布",
        ...
        importAsset: "导入资产",
        exportCurrent: "导出当前画布", openFolder: "打开画布文件夹", openFolderFailed: "无法打开画布文件夹",
        undo: "撤销",
        redo: "重做",
        openMenu: "打开画布菜单",
        renameHint: "双击修改画布名称",
        ...
        agentDisconnected: "Agent 未连接", agentMcpReady: "MCP 已注册",
        connecting: "连接中",
        openAgent: "打开本地 Codex 面板",
        nodeTypes: { image: "图片", text: "文本", config: "生成配置", video: "视频", audio: "音频", group: "组" },
        toolbar: {
            select: "选择", pan: "移动", text: "文本", image: "图片", video: "视频", audio: "音频", config: "生成配置", group: "组", extensions: "扩展节点", upload: "上传资产", paste: "粘贴", appearance: "画布外观", clear: "清空画布",
        ...
        project: {
            ...
            sync: "同步到云端", synced: "已同步 {{date}}", notSynced: "未同步", unsyncedChanges: "有未同步的更改",
        },
        localSection: "本地画布",
        cloudSection: "云端画布",
        cloudRefresh: "刷新",
        cloudLoading: "正在加载云端画布…",
        cloudEmpty: "云端还没有画布",
        cloudSynced: "已同步",
        pullToLocal: "拉取到本地",
        pulled: "已将 {{name}} 拉取到本地",
        pullFailed: "拉取画布失败",
        export: { defaultProjectName: "至简画布", defaultNodesName: "画布元素", item: "元素" },
        createMenu: {
        ...
        node: {
            node: "节点",
            untitled: "未命名节点", renameHint: "双击修改节点名称", group: "组", nodeCount: "{{count}} 个节点", generating: "生成中", progressPercent: "{{value}}%", failed: "生成失败", checkStatus: "查询状态", retry: "重试", missingPlugin: "缺少插件", missingPluginDescription: "节点类型“{{type}}”的插件未安装或未启用", generateImage: "用文本生图", generate: "生图", editText: "双击编辑文字", emptyImage: "空图片节点", emptyVideo: "空视频节点", emptyAudio: "空音频节点", mediaExpired: "媒体链接已过期", audio: "音频", play: "播放", pause: "暂停", playing: "播放中", playHint: "点播放 · 拖其他区域可移动", fullscreen: "全屏", batchExpanded: "图片组已展开", batchCollapsed: "图片组已收起", createCopy: "创建副本", setPrimary: "设为主图",
        },
        sidePanel: {
            canvas: "画布", assets: "资产", prompts: "提示词库", logs: "生成记录", resize: "调整左侧面板宽度", elements: "画布元素", select: "选择", searchNodes: "搜索节点", focusNode: "定位到节点", preview: "放大预览", noNodes: "画布暂无节点", clearAll: "取消全选", selected: "已选 {{count}}", exporting: "正在导出选中元素…", exportName: "画布元素-{{count}}个", exported: "已导出 {{count}} 个元素", exportFailed: "导出失败，请重试",
        ...
        tools: {
            open: "画布工具",
            title: "画布工具",
            subtitle: "上传或生成前，可先在这里处理素材。",
            compress: {
                title: "图片压缩",
                description: "在浏览器本地压缩图片体积，可调质量与最长边。",
                quality: "质量",
                maxEdge: "最长边 (px)",
                maxSizeMb: "目标大小 (MB)",
                hint: "使用 browser-image-compression 本地压缩。PNG 尽量保留 PNG；其他格式更适合 JPEG/WebP。",
                addImages: "添加图片",
                run: "开始压缩",
                downloadAll: "全部下载",
                clear: "清空",
                dropHint: "将图片拖到这里，或点击添加图片",
                imagesOnly: "仅支持图片文件",
                working: "压缩中…",
                download: "下载",
                done: "已压缩 {{count}} 张图片",
            ...
            toPng: {
                title: "转为 PNG",
                description: "在浏览器里把图片真正重编码为 image/png，不是只改后缀。",
                hint: "本地 Canvas 解码后再 PNG 编码。JPEG/WebP/GIF 会变成真正的 PNG；已是 PNG 的文件保持 PNG。部分浏览器可能不支持 HEIC。",
                addImages: "添加图片",
                run: "转为 PNG",
                downloadAll: "全部下载",
                dropHint: "将图片拖到这里，转为 PNG",
                working: "转换中…",
                done: "已将 {{count}} 张图片转为 PNG",
            },
        },
        ...
        cloudUpload: { title: "云端上传", queue: "{{current}} / {{total}}", pendingTitle: "未上传到云端", empty: "暂无上传任务", uploading: "上传中", waiting: "等待上传", failed: "上传失败", failedHint: "有上传失败，可重试或清除。", retry: "重试", cancel: "取消", dismiss: "关闭", dismissFailed: "清除失败", collapse: "收起", badge: "{{count}} 个上传" },
        projectPage: {
            stopTitle: "停止生成？", stopDescription: "当前生成请求会被中断，已经生成完成的内容会保留。", stop: "停止", continue: "继续生成", configConnection: "配置节点之间不能连接", notFound: "未找到当前画布", exporting: "正在导出当前画布…", exported: "已导出当前画布", uploadingFiles: "正在上传 {{count}} 个文件…", uploadedFiles: "已添加 {{count}} 个文件", uploadFailed: "上传失败，请重试", uploadingClipboardImage: "正在上传剪贴板图片…", clipboardReadFailed: "读取剪贴板失败，请重试或改用 Ctrl+V 粘贴", clipboardText: "剪切板文本", clipboardImageAdded: "已从剪切板添加图片", clipboardTextAdded: "已从剪切板添加文本", noTextToSave: "没有可保存的文本", canvasText: "画布文本", noVideoToSave: "没有可保存的视频", canvasVideo: "画布视频", noImageToSave: "没有可保存的图片", canvasImage: "画布图片", emptyReverse: "图片节点为空，无法反推提示词", reverseTitle: "反推提示词", reverseConfigTitle: "反推提示词配置", splitTitle: "{{name}} {{row}}-{{column}}", splitSuccess: "已切分为 {{count}} 个子节点", maskResult: "局部编辑结果", maskFailed: "局部修改失败", generationFailed: "生成失败", partialFailed: "部分图片生成失败", allFailed: "全部图片生成失败", imageJobTimeout: "等待服务端生图任务超时", imageJobMissing: "未找到可恢复的生图任务，请重新生成", imageJobEmpty: "生图任务已完成但没有可下载的结果", videoTaskMissing: "该节点没有可查询的任务 ID，请重新生成后再试", videoStillPending: "任务 {{id}} 仍在处理中，继续等待…", videoStatusAlreadyChecking: "该视频任务已在查询中，请稍候…", videoStatusRechecking: "正在重新查询视频任务状态…", videoStatusConfigRequired: "请先配置可用的视频渠道（Base URL 与 API Key），再查询状态", videoStatusRecovered: "视频任务已完成并回填到节点", videoTaskId: "任务 ID：{{id}}", videoTaskLabel: "视频任务 ID", retryPromptMissing: "找不到提示词，无法重试", referenceMissing: "参考图片已丢失，无法继续重试", emptyTextImage: "文本节点为空，无法生图", untitledCanvas: "未命名画布", superResolve: "AI 超分", notImplemented: "暂未实现", imageDetails: "图片详情", clearTitle: "清空画布？", clear: "清空", clearDescription: "这会删除当前画布上的所有节点和连线。", reversePreset: "请根据参考图片反推一段适合用于 AI 生图的提示词。\n\n要求：\n1. 只输出提示词正文，不要解释。\n2. 覆盖主体、构图、风格、光线、色彩、材质、镜头和氛围。\n3. 尽量写成可直接用于生图模型的完整提示词。", maskPrompt: "只修改蒙版透明区域，其他区域保持不变。{{prompt}}", editTextPrompt: "请根据要求修改以下文本。\n\n原文：\n{{source}}\n\n修改要求：\n{{prompt}}"
        },
        ...
        promptPanel: { video: "描述要生成的视频内容", audio: "描述要生成的音频内容", image: "描述要生成的图片内容", text: "请输入你想要生成的文本内容", editImage: "请输入你想要把这张图修改成什么", editText: "请输入你想要将本段文本修改成什么", expandEditor: "放大编辑", editorTitle: "编辑提示词", stopGeneration: "停止生成", generate: "生成", stop: "停止", optimizePrompt: "用文本模型优化提示词", optimizeConfirm: "将调用已配置的文本模型改写当前提示词，此操作会消耗文本模型 tokens。是否继续？", optimizeFailed: "提示词优化失败", optimizing: "正在优化提示词…", optimizeNeedsPrompt: "先输入提示词再优化", optimizeWhileRunning: "生成进行中，完成后再优化", optimizeTitle: "优化提示词", optimizeOriginal: "原提示词", optimizeResult: "优化结果", optimizeApply: "使用优化结果" },
        storyboard: { toolbar: "批量分镜", title: "批量导入分镜词", fillExample: "填充示例", placeholder: "粘贴分镜词全文（含全局规则、参考素材区、镜号 1…N），每个镜号生成一个视频节点", detected: "识别到 {{count}} 个分镜", assetsDetected: "{{count}} 处资产引用将自动连线", noShots: "未识别到镜号标记（镜号/镜头/SHOT/SCENE N）", import: "导入并生成 {{count}} 个视频节点", imported: "已导入 {{count}} 个分镜，自动连接 {{assets}} 个资产" },
        composer: { title: "组装提示词", description: "@ 引用已连接资产，发送前按当前连接重新编号", placeholder: "输入提示词，按 @ 引用连接的图片或文本", imagePreview: "引用图片预览", resources: { image: "图片{{index}}", video: "视频{{index}}", audio: "音频{{index}}", text: "文本{{index}}" }, mentions: { connected: "已连接", canvasResources: "画布资源" } },
        controls: { ratio: "比例", duplicate: "复制", delete: "删除", images: "{{count}} 张", generations: "{{count}} 次", reasoning: "推理" },
        generation: { interrupted: "页面刷新后生成已中断，请前往左侧的生成记录查看生成的结果，不要重复点击生成哦。", front: "正面视角", rotateRight: "向右旋转 {{angle}} 度", rotateLeft: "向左旋转 {{angle}} 度", level: "水平视角", topDown: "俯视 {{angle}} 度", lowAngle: "仰视 {{angle}} 度", angleLabel: "AI 多角度：{{horizontal}}，{{pitch}}，镜头距离 {{distance}}，{{lens}}镜头", anglePrompt: "基于参考图重新生成同一主体的新视角，保持主体、颜色、材质和画面风格一致，不要只做透视变形。{{angle}}。" },
    ...
    config: {
        ...
        localStorage: {
            title: "本地数据存储使用情况",
            description: "查看 至简画布 在设备上保存的数据量，并按存储目录统计内容体积。",
            indexedDbUsage: "本地数据占用",
            siteUsage: "站点总占用",
            quota: "可用配额",
            ...
            customDataDir: "自定义文件存储目录",
            customDataDirEmpty: "未设置（使用默认位置）",
            customDataDirSet: "已设置自定义存储目录",
            customDataDirReset: "已重置为默认位置",
            customDataDirHint: "所有应用数据（画布项目、图片、视频、日志）都存储在此目录。更改目录将迁移现有数据。",
            changeDataDir: "更改",
            resetDataDir: "重置",
            moveDataDirFailed: "迁移数据目录失败",
            records: "{{count}} 条",
            refresh: "刷新统计",
            readFailed: "读取本地存储失败",
            syncedHint: "生图/视频历史和「我的资产」已同步到云端数据库。可清理本机副本释放空间；画布项目、配置和媒体文件仍会保留。",
            clearSynced: "清理已同步本地数据",
            clearSyncedTitle: "清理已同步本地数据？",
            clearSyncedDescription: "将删除本地的生图/视频历史记录，以及本地「我的资产」缓存。服务端数据保留，资产会从云端重新加载。画布项目与媒体文件不会删除。",
            clearSyncedDone: "已清理 {{imageLogs}} 条生图记录、{{videoLogs}} 条视频记录、{{assets}} 个本地资产",
            clearSyncedFailed: "清理已同步本地数据失败",
            stores: { appState: "应用状态", images: "图片文件", media: "音视频文件", imageLogs: "生图记录", videoLogs: "视频记录", agentMessages: "Agent 消息", promptCache: "提示词缓存", plugins: "插件数据", exports: "导出文件" },
        },
        promptSources: {
            add: "新增来源",
            sync: "同步",
            synced: "已同步 {{count}} 个来源",
            deleteTitle: "删除「{{name}}」？",
        ...
        fileSecurity: "JSON 文件包含 API Key 等敏感信息，请妥善保管。",
        import: "导入配置",
        export: "导出配置",
        imported: "配置与用户偏好已导入",
        ...
        onboarding: {
            ...
            steps: {
                welcome: {
                    title: "先认识一下配置",
                    body: "生成图片、视频前，需要先在「配置与用户偏好」里接好模型渠道。接下来用大约半分钟带你走一遍关键设置。",
                },
                settings: {
                    title: "打开配置入口",
                    body: "点击右上角齿轮图标，打开「配置与用户偏好」。也可以直接点「下一步」由引导帮你打开。",
                },
                channels: {
                    title: "渠道：接模型的地方",
                    body: "每个渠道对应一套接口协议、地址和密钥，并为模型指定能力（生图 / 视频 / 文本 / 音频）。内嵌网关会自动帮你填好默认渠道，也可自行新增。",
                },
                baseUrl: {
                    title: "接口地址（Base URL）",
                    body: "填写 API 服务根地址，例如本站网关或自建中转。不要漏协议（https://），一般也不需要手动再拼 /v1。",
                },
                apiKey: {
                    title: "API Key",
                    body: "粘贴令牌密钥（通常以 sk- 开头）。密钥只保存在本机浏览器，请勿分享给他人。",
                },
                preferences: {
                    title: "偏好：默认模型与生成习惯",
                    body: "在这里选择默认生图 / 视频 / 文本 / 音频模型，以及画布默认张数、系统提示词等。节点里仍可单独覆盖。",
                },
                retention: {
                    title: "画布素材仅保存 2 天",
                    body: "我们的画布素材图片仅保存 2 天哦，有需要的可以也备份下载一份到本地。左侧边栏底部也会一直显示这条提示。",
                },
                generationLogs: {
                    title: "以「生成记录」为准",
                    body: "左侧栏的「生成记录」会同步生图/视频结果。请以生成记录为准；画布偶发网络波动可能导致节点失败，结果仍以生成记录为准。有 pending 或新完成时，Tab 上也会出现角标提醒。",
                },
                done: {
                    title: "可以开始了",
                    body: "配置好渠道和偏好后，回到画布添加节点即可生成。之后若要再看一遍，可在配置弹窗里点「重新查看引导」。",
                },
            },
        },
        channels: {
        ...
        modelSelect: {
            ...
            add: "增加模型",
            fetch: "拉取模型列表",
            description: "本站网关会走 /api/canvas/models（含能力标签）；自定义 Base URL 仍走上游 /models。也可手动增加模型名称。",
    ...
    agent: {
        status: { failed: "连接失败", connected: "已连接", connecting: "连接中", disconnected: "未连接", mcpReady: "终端可用" },
        ...
        mcp: { noCanvas: "当前没有打开的画布", opsRequired: "ops 不能为空", nothingToUndo: "没有可撤销的画布操作" }, siteTools: { canvasList: "画布列表", generationStatus: "生成任务状态", imageConfig: "生图配置", imageGenerate: "生图工作台生成", videoConfig: "视频配置", videoGenerate: "视频创作台生成", promptSearch: "搜索提示词", assetList: "资产列表", assetAdd: "添加资产", unknownTool: "未知工具：{{name}}", canvasLoading: "画布还在加载中，请稍后重试", canvasHint: "用 site_navigate 跳转 /canvas/{id} 打开对应画布", assetsLoading: "资产还在加载中，请稍后重试", assetTitleRequired: "请提供资产标题 title", textContentRequired: "kind=text 时需要提供 content 文本内容", imageUrlRequired: "kind=image 时需要提供 imageUrl（图片地址或 dataURL）", imageReadFailed: "无法读取该图片地址，请改用 dataURL 或可跨域访问的图片链接", assetKindUnsupported: "assets_add 仅支持 kind=text 或 kind=image", imageGenerationStarted: "已跳转生图工作台并触发生成，可用 generation_get_status 查询任务", imageConfigApplied: "已跳转生图工作台并填入参数，未触发生成", videoGenerationStarted: "已跳转视频创作台并触发生成，可用 generation_get_status 查询任务", videoConfigApplied: "已跳转视频创作台并填入参数，未触发生成" },
        builtin: { systemPrompt: "你是 Minimalist Canvas 的内置画布 Agent。你可以调用工具查看画布、搜索提示词与资产，并驱动图片/视频生成。回复请简洁。多步骤任务先调用 update_plan 列出步骤，完成一步就更新进度。有 use_skill 工具可用时，先做对应类型的工作前激活相关技能。", systemPromptCanvas: "画布规则：先用 canvas_get_state 查看当前节点。创建、更新、连接、删除节点只能通过 canvas_apply_ops，且必须使用快照中真实存在的节点 id，不要编造 id。要串联工作流（如 文本提示词 -> 图片 -> 视频），用 connect_nodes 连接节点后对目标节点调用 run_generation。优先小批量提交 ops，大改动后用 canvas_get_state 核对结果。canvas_apply_ops 返回审计报告：检查 `skipped` 里失败的 op（含原因）并在下一轮修正；后续 connect_nodes 用 `createdNodeIds` 里的 id；run_generation 是异步排队，用 generation_get_status 轮询确认结果。", toolLimitReached: "已在 {{count}} 轮工具调用后停止。如任务还需更多步骤请继续追问。", noToolsSupport: "当前文本模型不支持工具调用，本轮回复无法操作画布。", skillPicker: "选择本地技能", noSkill: "不使用技能", skillNotFound: "找不到技能：{{name}}" },
        mcpClient: { title: "MCP 服务器", add: "添加服务器", connectAll: "全部连接", remove: "移除", removeTitle: "移除这个 MCP 服务器？", nameRequired: "请输入服务器名称", namePlaceholder: "服务器名称", urlRequired: "请输入服务器 URL", urlPlaceholder: "https://example.com/mcp", commandRequired: "请输入命令", commandPlaceholder: "npx -y @modelcontextprotocol/server-filesystem ~", stdioDesktopOnly: "stdio 服务器仅桌面端可用", noResponse: "MCP 服务器无响应", toolFailed: "MCP 工具执行失败：{{name}}", timeout: "MCP 请求超时：{{method}}", unknownTool: "未知 MCP 工具：{{name}}", notConnected: "MCP 服务器未连接：{{server}}", idle: "未连接", connecting: "连接中…", error: "连接失败", toolCount: "{{count}} 个工具" },
        connect: { pluginTitle: "应用内对话", pluginText: "右侧对话使用配置中心的渠道 Base URL、API Key 与文本模型，不再依赖外部 Canvas Agent。", directTitle: "终端 Codex（可选）", directText: "如需在终端用 Codex CLI 操作画布，可注册 MCP。与右侧对话互不依赖。", registerMcp: "注册到 Codex", openTerminal: "打开终端运行 Codex", terminalOpened: "已打开终端", mcpRegistered: "已注册到 Codex，新会话生效", mcpRegisteredBadge: "MCP 已注册", mcpNotRegistered: "MCP 未注册", mcpUsageRegistered: "MCP 已就绪，可在终端用 Codex 操作画布。右侧对话使用本机 AI 配置，与 MCP 无关。", mcpUsageConnected: "本地 Agent 已连接，可直接在右侧对话。终端里的 Codex 也可通过 MCP 读写画布。", codexNotInstalled: "未检测到 Codex CLI。请先安装：curl -fsSL https://chatgpt.com/codex/install.sh | bash", mcpServer: "本地 MCP 服务", mcpRunning: "运行中", mcpUsage: "注册后可在终端运行 Codex 读写画布。右侧对话用的是本机 AI 配置，与 MCP 无关。", commandCopied: "命令已复制", pluginReminder: "Codex 插件提醒", pluginReminderText: "只有安装 Codex 插件或手动添加 MCP 后，工具列表才会进入 Codex 上下文并增加 token 消耗；", removePlugin: "移除插件", removeMcp: "移除手动 MCP", copyCommand: "复制命令", title: "连接设置", description: "应用内对话使用你配置的 Base URL 和 API Key；终端 Codex 可选注册 MCP。", builtinDescription: "右侧对话由本客户端直接调用模型。请在「配置 → 模型渠道」填写 Base URL 和 API Key。", configureAiFirst: "请先在配置中心打开「模型渠道」，填写 Base URL、API Key，并添加文本模型。", openAiConfig: "打开 AI 配置", aiNotReady: "未配置模型", syncingModels: "正在同步文本模型…", aiReady: "模型已就绪", aiReadyDetail: "当前文本模型：{{model}}", webConnection: "网页连接", autoDiscover: "默认自动读取 Local URL 和 Connect token，失败时再手动填写。", disconnect: "断开", connect: "连接", connectInApp: "连接应用内对话", inAppTitle: "应用内对话状态", inAppHint: "连上后可直接在右侧面板和 Codex 对话并改画布。", startAgentHint: "桌面端 17371 已被内置 MCP 占用。另开终端执行：PORT=17372 npx -y @basketikun/canvas-agent，把输出的 Local URL / Connect token 填到下方再连接。", localAddress: "本地地址", urlPlaceholder: "例如 http://127.0.0.1:17371", token: "连接 Token", tokenPlaceholder: "自动发现，或手动填入 Connect token", settingsTab: "设置", channelLabel: "渠道", channelEmpty: "未选择渠道", baseUrlEmpty: "未填写 Base URL", modelLabel: "模型", modelEmpty: "未选择文本模型", baseUrlLabel: "Base URL", baseUrlHint: "Base URL 在顶部导航「配置」→「模型渠道」→ 编辑渠道里填写；对话区也可切换文本模型。",},
