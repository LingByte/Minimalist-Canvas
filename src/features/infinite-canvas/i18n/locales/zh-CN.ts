export default {
    ...
    canvas: {
        ...
        cloudUpload: { title: "云端上传", queue: "{{current}} / {{total}}", pendingTitle: "未上传到云端", uploading: "上传中", waiting: "等待上传", failed: "上传失败", failedHint: "有上传失败，可重试或清除。", retry: "重试", cancel: "取消", dismiss: "关闭", dismissFailed: "清除失败", collapse: "收起", badge: "{{count}} 个上传" },
        projectPage: {
