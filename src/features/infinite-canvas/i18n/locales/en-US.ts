export default {
    ...
    canvas: {
        ...
        promptPanel: { video: "Describe the video you want to generate", audio: "Describe the audio you want to generate", image: "Describe the image you want to generate", text: "Describe the text you want to generate", editImage: "Describe how you want to change this image", editText: "Describe how you want to revise this text", expandEditor: "Expand editor", editorTitle: "Edit prompt", stopGeneration: "Stop generation", generate: "Generate", stop: "Stop", optimizePrompt: "Rewrite prompt with the text model", optimizeConfirm: "This rewrites the current prompt with your configured text model and consumes text-model tokens. Continue?", optimizeFailed: "Prompt optimization failed", optimizing: "Optimizing prompt…", optimizeNeedsPrompt: "Enter a prompt first to optimize", optimizeWhileRunning: "Wait for generation to finish before optimizing", optimizeTitle: "Optimize prompt", optimizeOriginal: "Original", optimizeResult: "Optimized", optimizeApply: "Use optimized prompt" },
        storyboard: { toolbar: "Storyboard import", title: "Batch storyboard import", fillExample: "Fill example", placeholder: "Paste the full storyboard script (global rules, reference-asset section, 镜号/SHOT 1…N). One video node is created per detected shot.", detected: "Detected {{count}} shots", assetsDetected: "{{count}} asset references will auto-connect", noShots: "No shot markers found (镜号/镜头/SHOT/SCENE N)", import: "Import {{count}} video nodes", imported: "Imported {{count}} shots, auto-connected {{assets}} assets" },
        composer: { title: "Compose prompt", description: "Use @ to reference connected assets; references are renumbered before sending", placeholder: "Enter a prompt and use @ to reference connected images or text", imagePreview: "Referenced image preview", resources: { image: "Image {{index}}", video: "Video {{index}}", audio: "Audio {{index}}", text: "Text {{index}}" }, mentions: { connected: "Connected", canvasResources: "Canvas assets" } },
