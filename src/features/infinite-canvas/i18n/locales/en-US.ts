export default {
    ...
    canvas: {
        ...
        sidePanel: {
            ...
            logsAuthorityTip: "Treat generation history as the source of truth. Canvas nodes may fail during network blips; check history for the real result.",
        ...
        cloudUpload: { title: "Cloud upload", queue: "{{current}} / {{total}}", pendingTitle: "Not uploaded yet", uploading: "Uploading", waiting: "Waiting", failed: "Upload failed" },
        projectPage: {
