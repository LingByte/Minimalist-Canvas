export default {
    ...
    canvas: {
        ...
        cloudUpload: { title: "Cloud upload", queue: "{{current}} / {{total}}", pendingTitle: "Not uploaded yet", uploading: "Uploading", waiting: "Waiting", failed: "Upload failed", failedHint: "Some uploads failed. Retry or dismiss them.", retry: "Retry", cancel: "Cancel", dismiss: "Dismiss", dismissFailed: "Clear failed", collapse: "Collapse", badge: "{{count}} uploads" },
        projectPage: {
