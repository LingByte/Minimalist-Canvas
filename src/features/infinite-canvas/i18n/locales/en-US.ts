export default {
    ...
    config: {
        ...
        localStorage: {
            ...
            syncedHint: "Generation history and My Assets are already stored in the database. You can clear their local copies to free space. Canvas projects, config, and media blobs are kept.",
    ...
    agent: {
        ...
        connect: { pluginTitle: "Option 1: Use the Codex plugin", pluginText: "Install the Minimalist Canvas plugin in the Codex app and launch the canvas through it. The plugin starts the local Agent and supplies the connection details automatically.", directTitle: "Option 2: Register in Codex CLI", directText: "Run the command below or click the register button to write the canvas MCP tools into the Codex config. Codex sessions can then read and edit the current canvas.", registerMcp: "Register to Codex", mcpRegistered: "Registered to Codex. Takes effect in new sessions.", mcpServer: "Local MCP server", mcpRunning: "Running", mcpUsage: "Run codex in a terminal to use the canvas tools in your session. Canvas read/write requires an open canvas.", commandCopied: "Command copied", pluginReminder: "Codex plugin note", pluginReminderText: "The tool list enters the Codex context and consumes additional tokens only after installing the Codex plugin or adding MCP manually.", removePlugin: "Remove plugin", removeMcp: "Remove manual MCP", copyCommand: "Copy command", title: "Connect local Agent", description: "Choose the connection method that fits your workflow.", webConnection: "Web connection", autoDiscover: "The Local URL and Connect token are discovered automatically by default. Enter them manually only if discovery fails.", disconnect: "Disconnect", connect: "Connect", localAddress: "Local address", urlPlaceholder: "For example http://127.0.0.1:17371", token: "Connection token", tokenPlaceholder: "Discover automatically or enter the Connect token" },
        ...
        panel: { connectionSettings: "Connection settings · {{status}}", connectionSettingsLabel: "Connection settings. Current status: {{status}}", chat: "Chat", history: "History", skills: "Skills", logs: "Logs", collapse: "Collapse chat", collapseLabel: "Collapse Agent panel", resize: "Resize right panel", content: "Agent content", connectHint: "Local Agent not connected — run codex in a terminal to drive the canvas.", mcpInitializing: "MCP is initializing. You can send messages when it is ready.", initFailed: "Codex conversation initialization failed. Start or resume a conversation.", placeholder: "Ask Codex, type / for Skills, or @ to reference canvas assets" },
