export default {
    ...
    config: {
        ...
        localStorage: {
            ...
            description: "View browser data saved by Minimalist Canvas, grouped by object store.",
            ...
            customDataDirHint: "Used for exported canvases, media files, etc. IndexedDB/browser storage is still system-managed and cannot be moved.",
