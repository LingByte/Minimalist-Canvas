    ...
    valueContent = (
      ...
      >
        <Skeleton.Input
          active
          size='small'
          style={{ width: 64, height: 20, minWidth: 64 }}
          className='sm:!h-7 sm:!w-24'
        />
        <Skeleton.Input
          active
          size='small'
          style={{ width: 96, height: 12, minWidth: 96 }}
          className={cn(
            'sm:!h-3.5 sm:!w-32',
  ...
  return (
    <div
      ...
      className={cn(
        ...
        props.compactMobile ? 'gap-1' : 'gap-1.5',
        props.onOpen &&
          'cursor-pointer rounded-lg outline-none transition-colors hover:bg-black/[0.03] focus-visible:ring-2 focus-visible:ring-primary/40 dark:hover:bg-white/[0.04]'
      )}
    >
      ...
      {props.onOpen && props.openHint ? (
        <p className='text-primary hidden text-[11px] font-medium sm:block'>
          {props.openHint}
        </p>
      ) : null}
