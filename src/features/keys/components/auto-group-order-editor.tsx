  ...
  return (
    ...
    >
      ...
      {isInheriting && props.globalOptions.length === 0 && (
        <Empty
          className='min-h-28 border py-4'
          description={
            <div>
              <div className='font-medium'>{t('Inherit global Auto order')}</div>
      ...
      {!isInheriting && props.value.length === 0 && (
        <Empty
          className='min-h-24 border py-4'
          description={
            <div>
              <div className='font-medium'>{t('Auto group order')}</div>
              <div className='text-muted-foreground text-sm'>
                {t(
